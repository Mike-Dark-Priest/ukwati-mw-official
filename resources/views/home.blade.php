...
<div id="page">
    <nav class="fh5co-nav" role="navigation">
        <div class="container">
            <div class="row">
                <div class="col-xs-2">
                    <div id="fh5co-logo"><a href="{{ asset('index.html') }}">Wedding<strong>.</strong></a></div>
                </div>
                <div class="col-xs-10 text-right menu-1">
                    <ul>
                        <li class="active"><a href="{{ asset('index.html') }}">Home</a></li>
                        <li><a href="{{ asset('about.html') }}">Story</a></li>
                        <li class="has-dropdown">
                            <a href="{{ asset('services.html') }}">Services</a>
                            <ul class="dropdown">
                                <li><a href="{{ asset('#') }}">Web Design</a></li>
                                <li><a href="{{ asset('#') }}">eCommerce</a></li>
                                <li><a href="{{ asset('#') }}">Branding</a></li>
                                <li><a href="{{ asset('#') }}">API</a></li>
                            </ul>
                        </li>
                        <li class="has-dropdown">
                            <a href="{{ asset('gallery.html') }}">Gallery</a>
                            <ul class="dropdown">
                                <li><a href="{{ asset('#') }}">HTML5</a></li>
                                <li><a href="{{ asset('#') }}">CSS3</a></li>
                                <li><a href="{{ asset('#') }}">Sass</a></li>
                                <li><a href="{{ asset('#') }}">jQuery</a></li>
                            </ul>
                        </li>
                ...
                <div class="col-md-8 col-md-offset-2 text-center">
                    <div class="display-t">
                        <div class="display-tc animate-box" data-animate-effect="fadeIn">
                            ...
                            <p><a href="{{ asset('#') }}" class="btn btn-default btn-sm">Save the date</a></p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="owl-carousel-fullwidth">
                                <div class="item">
                                    <div class="testimony-slide active text-center">
                                        ...
                                        <span>John Doe, via <a href="{{ asset('#') }}" class="twitter">Twitter</a></span>
                                        <blockquote>
            ...
            <div class="row copyright">
                <div class="col-md-12 text-center">
                    ...
                    <ul class="fh5co-social-icons">
                        ...
                        <li><a href="{{ asset('#') }}"><i class="icon-linkedin"></i></a></li>
                        <li><a href="{{ asset('#') }}"><i class="icon-dribbble"></i></a></li>
                    </ul>
                    </p>
                </div>
            </div>
...
<div class="gototop js-top">
    <a href="{{ asset('#') }}" class="js-gotop"><i class="icon-arrow-up"></i></a>
</div>
